...
exports.isLastBettor = isLastBettor;
exports.validBetsForLastBettor = validBetsForLastBettor;
/**
 ...
 */
function validateBet(bet, playerId, playerData, cardsInRound, isLastBettor) {
 ...
 */
function isLastBettor(playerId, bettingOrder, playerData) {
 ...
 */
function validBetsForLastBettor(playerData, lastBettorId, cardsInRound) {
    const currentSum = playerData
